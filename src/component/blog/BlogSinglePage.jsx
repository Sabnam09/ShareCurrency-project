        ...
        <>
            ...
            <section className='blog-singlepage-main-sec'>
                <div className="container">
                    <img src="https://dtdigibit.wpengine.com/wp-content/uploads/2018/01/Blog-2.jpg" class="img-fluid attachment-full size-full wp-post-image" alt="" decoding="async" fetchpriority="high" sizes="(max-width: 1230px) 100vw, 1230px"></img>
                    ...
                    <div className="row mt-5">
                        <div className="col-md-4 mb-4">
                            <Link to="/">
                                <img src="https://dtdigibit.wpengine.com/wp-content/uploads/2018/01/Blog-2-1024x696.jpg" class="img-fluid vc_gitem-zone-img" alt="Blog-2"></img>
                            </Link>
                        </div>
                        <div className="col-md-4 mb-4">
                            <Link to="/">
                                <img src="https://dtdigibit.wpengine.com/wp-content/uploads/2018/01/Blog1-1024x696.jpg" class="img-fluid vc_gitem-zone-img" alt="Blog1"></img>
                            </Link>
                        </div>
                        <div className="col-md-4">
                            <Link to="/">
                                <img src="https://dtdigibit.wpengine.com/wp-content/uploads/2018/01/Blog-3-1024x696.jpg" class="img-fluid vc_gitem-zone-img" alt="Blog-3"></img>
                            </Link>
                        </div>
                    </div>
